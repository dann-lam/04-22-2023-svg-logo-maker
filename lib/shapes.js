...
class triangle extends shape {
    ...
    render(){
        return `<svg height="300" width="200" viewBox="0 0 100 100">
            ...
            <text x="55" y="75" font-size="15" fill="${this.textColor}">${this.title}</text>
      </svg>`
    }
}
...
class square extends shape {
    ...
    render(){
        ...
        <text x="50" y="75" font-size="15" fill="${this.textColor}">${this.title}</text>
      </svg>`
    }
}
...
class circle extends shape {
    ...
    render(){
        ...
        <text x="50" y="150" font-size="35" fill="${this.textColor}">${this.title}</text>
      </svg>`
    }
}
