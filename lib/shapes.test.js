...
describe('Tests all Shapes', () => {
    describe("Triangle Test", () => {
        it('Affirmative test for Triangles', () => {
            ...
            expect(result).toBe(`<svg height="300" width="200" viewBox="0 0 100 100"><polygon points="50 0, 100 100, 0 100" fill="white"/><text x="55" y="75" font-size="15" fill="black">testTitle</text></svg>`)
        })
    })
    ...
    describe("circle Test", () => {
        it('Affirmative test for circles', () => {
            ...
            expect(result).toBe(`<svg height="300" width="200"><circle cx="100" cy="100" r="100" fill="white" /><text x="50" y="150" font-size="35" fill="black">testcircle</text></svg>`)
        })
    })
})
